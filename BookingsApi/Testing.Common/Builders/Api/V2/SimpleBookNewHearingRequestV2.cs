...
public class SimpleBookNewHearingRequestV2
{
    ...
    public SimpleBookNewHearingRequestV2(string caseName, DateTime scheduledDateTime)
    {
        ...
        participants[2].HearingRoleCode = HearingRoleCodes.Intermediary;
        ...
        participants[3].HearingRoleCode = HearingRoleCodes.WelfareRepresentative;
        ...
        participants[4].HearingRoleCode = HearingRoleCodes.Judge;
