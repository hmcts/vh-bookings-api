...
public class JusticeUser : TrackableEntity<Guid>
{
    ...
    public IList<JusticeUserRole> JusticeUserRoles { get; set; }
    public IList<VhoNonAvailability> VhoNonAvailability { get; protected set; }
    public IList<VhoWorkHours> VhoWorkHours { get; protected set; }
    public IList<Allocation> Allocations { get; protected set; }
    ...
    public bool IsDuringNonAvailableHours(DateTime startDate, DateTime endDate)
    {
        ...
        return nonAvailabilities.Count != 0;
    }
