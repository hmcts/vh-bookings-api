...
namespace BookingsApi.Client
{
    ...
    public partial class BookingsApiClient : IBookingsApiClient
    {
        ...
        {
            return GetPersonBySearchTermAndAccountTypeAsync(request, System.Threading.CancellationToken.None);
        }
        ...
        public async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<PersonResponse>> GetPersonBySearchTermAndAccountTypeAsync(SearchTermAndAccountTypeRequest request, System.Threading.CancellationToken cancellationToken)
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/persons/search-term-and-account-type");
