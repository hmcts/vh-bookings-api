...
namespace BookingsApi.Client
{
    ...
    public partial interface IBookingsApiClient
    {
        ...
        /// <exception cref="BookingsApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task RetryHearingAsync(System.Guid? hearingId);

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="BookingsApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task RetryHearingAsync(System.Guid? hearingId, System.Threading.CancellationToken cancellationToken);
    ...
    public partial class BookingsApiClient : IBookingsApiClient
    {
        ...
        /// <exception cref="BookingsApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task RetryHearingAsync(System.Guid? hearingId)
        {
            return RetryHearingAsync(hearingId, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="BookingsApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task RetryHearingAsync(System.Guid? hearingId, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/hearings?");
            if (hearingId != null)
            {
                urlBuilder_.Append(System.Uri.EscapeDataString("hearingId") + "=").Append(System.Uri.EscapeDataString(ConvertToString(hearingId, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            }
            urlBuilder_.Length--;
