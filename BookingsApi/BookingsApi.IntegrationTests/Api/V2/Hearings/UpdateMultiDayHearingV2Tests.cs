...
{
    public class UpdateMultiDayHearingV2Tests : ApiTest
    {
        [Test]
        public async Task should_update_multi_day_hearing()
        {
            // Arrange
            ...
            var request = new UpdateMultiDayHearingRequestV2
            {
            ...
            var result = await client
                .PatchAsync(ApiUriFactory.HearingsEndpointsV2.UpdateMultiDayHearing(groupId),RequestBody.Set(request));
