...
namespace BookingsApi.IntegrationTests.Helper
{
    public class TestDataManager
    {
            ...
            bool isMultiDayFirstHearing = false)
        {
            ...
            var hearingType = caseType.HearingTypes.FirstOrDefault(x => x.Name == options.HearingTypeName);
            ...
            Action<SeedVideoHearingOptions> configureOptions = null)
        {
            ...
            var videoHearing = new VideoHearing(caseType, scheduledDate, duration, venue, hearingRoomName, otherInformation, createdBy, audioRecordingRequired, cancelReason);
            videoHearing.SetHearingType(hearingType);
