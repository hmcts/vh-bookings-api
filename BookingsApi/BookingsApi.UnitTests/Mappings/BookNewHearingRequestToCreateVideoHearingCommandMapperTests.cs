...
using ILogger = BookingsApi.Common.ILogger;
...
namespace BookingsApi.UnitTests.Mappings
{
    public class BookNewHearingRequestToCreateVideoHearingCommandMapperTests
    {
        ...
        public void SetUp()
        {
            ...
            _kinlyConfiguration = Mock.Of<KinlyConfiguration>();
        ...
        {
            var command = BookNewHearingRequestToCreateVideoHearingCommandMapper.Map(_request, _caseType, _hearingType, _venue, _cases,
                _randomGenerator, _kinlyConfiguration, _logger);
