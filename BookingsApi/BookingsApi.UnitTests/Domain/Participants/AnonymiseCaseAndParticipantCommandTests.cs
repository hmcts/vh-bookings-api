...
namespace BookingsApi.UnitTests.Domain.Participants
{
    public class AnonymiseCaseAndParticipantCommandTests
    {
        ...
        private async Task SeedHearings()
        {
            ...
            _hearing1 = new VideoHearing(_caseType1, hearingType, DateTime.Today, 40, new HearingVenue(1, "venue 1"), 
                Faker.Name.First(), Faker.Name.First(), null, false, null);
            
            _hearing2 = new VideoHearing(_caseType1, hearingType, DateTime.Today, 40, new HearingVenue(1, "venue 1"), 
                Faker.Name.First(), Faker.Name.First(), null, false, null);
            
            _hearing3 = new VideoHearing(_caseType1, hearingType, DateTime.Today, 40, new HearingVenue(1, "venue 1"), 
                Faker.Name.First(), Faker.Name.First(), null, false, null);
