...
namespace BookingsApi.UnitTests.Domain.Hearing
{
    public class AddEndpointTests
    {
        ...
        public void Should_add_new_endpoint()
        {
            ...
            hearing.AddEndpoint(new BookingsApi.Domain.Endpoint("DisplayName", "sip@address.com", "1111"));
        ...
        {
            var hearing = new VideoHearingBuilder().Build();
            var ep = new BookingsApi.Domain.Endpoint("DisplayName", "sip@address.com", "1111");
