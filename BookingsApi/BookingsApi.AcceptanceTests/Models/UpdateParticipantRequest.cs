...
namespace BookingsApi.AcceptanceTests.Models
{
    ...
    {
        public static BookingsApi.Contract.V1.Requests.UpdateParticipantRequest BuildRequest()
        {
            return new BookingsApi.Contract.V1.Requests.UpdateParticipantRequest
            {
                Title = "Mr",
        ...
        public static BookingsApi.Contract.V1.Requests.UpdateParticipantRequest WithLinkedParticipants(this BookingsApi.Contract.V1.Requests.UpdateParticipantRequest updateParticipantRequest, string participantEmail, string interpreterEmail)
        {
