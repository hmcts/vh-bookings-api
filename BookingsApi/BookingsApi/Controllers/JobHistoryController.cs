...
namespace BookingsApi.Controllers
{
    ...
    public class JobHistoryController : Controller
    {
        ...
        [ProducesResponseType(typeof(List<JobHistory>), (int) HttpStatusCode.OK)]
        [ProducesResponseType((int) HttpStatusCode.BadRequest)]
        public async Task<IActionResult> GetJobHistory(string jobName) 
            => Ok(await _queryHandler.Handle<GetJobHistoryByJobNameQuery, List<JobHistory>>(new GetJobHistoryByJobNameQuery(jobName)));
    }
}