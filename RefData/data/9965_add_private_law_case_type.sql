...
CREATE PROCEDURE #Upsert_PrivateLawHearingTypes @id int, @hearingTypeName nvarchar(max), @hearingTypeCode varchar(450), @welshName nvarchar(max), @privateLawCaseTypeId int
As
BEGIN
