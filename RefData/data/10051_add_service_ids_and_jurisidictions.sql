...
CREATE PROC #Jurisdiction_CreateIfNotExist @id int, @name varchar(max)
AS
BEGIN
...
CREATE PROC #CaseType_Update @name varchar(max), @serviceId nvarchar(max), @jurisdictionName nvarchar(max)
AS
BEGIN
