...
--CREATE
EXEC #CREATE_CASE_TYPES_V10192 65, 'Examination Boards', 'BAA7', @JurisdictionId; --BAA7
--UPDATE
...
--CREATE
EXEC #CREATE_CASE_TYPES_V10192 66, 'Electronic Communications, Postal Services & Network Information Systems', 'BAB5', @JurisdictionId; --BAB5
--UPDATE
EXEC #UPDATE_CASE_TYPES_V10192 'GRC - Food', 'Food Safety', 'BAB6', @JurisdictionId; --BAB6
--CREATE
EXEC #CREATE_CASE_TYPES_V10192 67, 'Individual Electoral Registration', 'BAB7', @JurisdictionId; --BAB7
EXEC #CREATE_CASE_TYPES_V10192 68, 'Licensing and Standards', 'BAB8', @JurisdictionId; --BAB8
--UPDATE
...
--CREATE
EXEC #CREATE_CASE_TYPES_V10192 69, 'Primary Health Lists', 'BCA3', @JurisdictionId; --BCA3
--UPDATE
...
--CREATE
EXEC #CREATE_CASE_TYPES_V10192 70, 'MP’s Expenses', 'BDA1', @JurisdictionId; --BDA1
EXEC #CREATE_CASE_TYPES_V10192 71, 'Agricultural Land and Drainage', 'BGA1', @JurisdictionId; --BGA1
EXEC #CREATE_CASE_TYPES_V10192 72, 'Residential Property', 'BGA3', @JurisdictionId; --BGA3
--UPDATE
EXEC #UPDATE_CASE_TYPES_V10192 'Employment Tribunal', 'Employment Claims', 'BHA1',  @JurisdictionId; --BHA1
--CREATE
EXEC #CREATE_CASE_TYPES_V10192 73, 'Gangmasters Licensing Appeals', 'BHA2', @JurisdictionId; --BHA2
EXEC #CREATE_CASE_TYPES_V10192 74, 'Reserve Forces Appeal Tribunal', 'BHA3', @JurisdictionId; --BHA3
