...
namespace Testing.Common.Builders.Domain
{
    public class VideoHearingBuilder
    {
        ...
        public VideoHearingBuilder()
        {
            ...
            var duration = 80;
            var otherInformation = "information";
            var hearingRoomName = "test room 001";

            _videoHearing =  Builder<VideoHearing>.CreateNew().WithFactory(() =>
                new VideoHearing(caseType, hearingType, scheduledDateTime, duration, venue, otherInformation, hearingRoomName)).Build();
